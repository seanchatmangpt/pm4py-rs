...
fn bench_petri_net_discovery(c: &mut Criterion) {
    let mut group = c.benchmark_group("petri_net_discovery");
    group.sample_size(5);
        ...
        group.bench_with_input(
            ...
            |b, &events| {
                ...
                b.iter(|| {
                    ...
                    black_box(miner.discover(&black_box(log.clone())))
                });
            },
        );
    }
...
criterion_group!(benches, bench_petri_net_discovery);
