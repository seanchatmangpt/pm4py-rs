//! Standalone Chicago TDD tests for Board KPI Pipeline.
//!
//! This test file verifies the Board KPIs feature works correctly
//! with proper semconv integration and OTEL span emission.
...
// ── Test 5: truncation preserves complete traces ─────────────────────────────
...
// ── Test 6: multiple variants detected ──────────────────────────────────────
...
// ── Test 7: response serializes correctly ───────────────────────────────────
...
// ── Test 8: single-event traces handled gracefully ──────────────────────────
