...
pub fn call_filter_activities_rework(py: Python<'_>, log: &EventLog) -> PyResult<()> {
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_between(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_case_performance(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_case_size(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_dfg_activities_percentage(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_dfg_paths_percentage(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_directly_follows_relation(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_end_activities(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_event_attribute_values(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_eventually_follows_relation(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_four_eyes_principle(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_cc_activity(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_cc_length(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_cc_object(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_cc_otype(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_end_events_per_object_type(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_event_attribute(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_events(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_events_timestamp(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_object_attribute(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_object_per_type_count(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_object_types(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_objects(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_filter_ocel_start_events_per_object_type(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_paths_performance(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_prefixes(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_start_activities(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_suffixes(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_time_range(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_trace_attribute_values(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_trace_segments(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_variants(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_variants_by_coverage_percentage(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_filter_variants_top_k(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
