...
pub fn call_behavioral_similarity(py: Python<'_>, log: &EventLog) -> PyResult<()> {
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_check_is_workflow_net(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_check_soundness(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_cluster_log(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_compute_emd(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_construct_synchronous_product_net(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_embeddings_similarity(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_generate_marking(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
pub fn call_get_activity_labels(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_get_enabled_transitions(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_insert_artificial_start_end(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_insert_case_arrival_finish_rate(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_insert_case_service_waiting_time(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_label_sets_similarity(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_map_labels_from_second_model(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_maximal_decomposition(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_reduce_petri_net_implicit_places(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_reduce_petri_net_invisibles(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_replace_activity_labels(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_simplicity_petri_net(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_solve_extended_marking_equation(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_solve_marking_equation(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_structural_similarity(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
