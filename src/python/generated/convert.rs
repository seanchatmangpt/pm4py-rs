...
pub fn call_convert_log_to_networkx(py: Python<'_>, log: &EventLog) -> PyResult<()> {
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_log_to_ocel(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_log_to_time_intervals(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
pub fn call_convert_ocel_to_networkx(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_petri_net_to_networkx(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_petri_net_type(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_bpmn(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_dataframe(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_event_log(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_event_stream(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_petri_net(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_powl(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_process_tree(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_convert_to_reachability_graph(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
