...
pub fn call_correlation_miner(py: Python<'_>, log: &EventLog) -> PyResult<()> {
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_derive_minimum_self_distance(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_batches(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_bpmn_inductive(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_declare(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_dfg(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_dfg_typed(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_directly_follows_graph(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
pub fn call_discover_etot(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_eventually_follows_graph(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_footprints(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_heuristics_net(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_log_skeleton(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_discover_otg(py: Python<'_>, ocel: &PyAny) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_performance_dfg(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
pub fn call_discover_petri_net_alpha(py: Python<'_>, log: &EventLog) -> PyResult<PetriNet> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `petri_net_triple`
pub fn call_discover_petri_net_alpha_plus(py: Python<'_>, log: &EventLog) -> PyResult<PetriNet> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `petri_net_triple`
pub fn call_discover_petri_net_heuristics(py: Python<'_>, log: &EventLog) -> PyResult<PetriNet> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `petri_net_triple`
pub fn call_discover_petri_net_ilp(py: Python<'_>, log: &EventLog) -> PyResult<PetriNet> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `petri_net_triple`
pub fn call_discover_petri_net_inductive(py: Python<'_>, log: &EventLog) -> PyResult<PetriNet> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_powl(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_prefix_tree(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_process_tree_inductive(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_temporal_profile(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
...
///
/// Call style: `log_only` → convert: `unit`
pub fn call_discover_transition_system(py: Python<'_>, log: &EventLog) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
    let py_log = eventlog_to_pm4py(py, log)?;
