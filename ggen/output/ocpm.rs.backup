...
pub fn call_cluster_equivalent_ocel(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_discover_objects_graph(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
pub fn call_discover_oc_petri_net(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<PetriNet> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_add_index_based_timedelta(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_drop_duplicates(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_e2o_lifecycle_enrichment(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_get_attribute_names(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_get_object_types(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_merge_duplicates(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_o2o_enrichment(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_object_type_activities(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_objects_interactions_summary(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_objects_ot_count(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_objects_summary(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_sort_by_additional_column(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_ocel_temporal_summary(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_sample_ocel_connected_components(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `ocel_only` → convert: `unit`
pub fn call_sample_ocel_objects(
    py: Python<'_>,
    ocel: &PyAny,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
