...
///
/// Call style: `io_write` → convert: `unit`
pub fn call_write_ocel2_sqlite(
    py: Python<'_>,
    log: &EventLog,
    path: &str,
) -> PyResult<()> {
