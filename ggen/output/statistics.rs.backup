...
pub fn call_get_activity_position_summary(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_all_case_durations(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
pub fn call_get_case_arrival_average(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<f64> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_end_activities(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_event_attribute_values(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_event_attributes(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_frequent_trace_segments(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_minimum_self_distance_witnesses(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_minimum_self_distances(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_rework_cases_per_activity(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_start_activities(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_stochastic_language(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_trace_attribute_values(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_trace_attributes(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_variants_as_tuples(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_get_variants_paths_duration(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
...
///
/// Call style: `log_only` → convert: `dict`
pub fn call_split_by_process_variant(
    py: Python<'_>,
    log: &EventLog,
) -> PyResult<()> {
    let pm4py = py.import("pm4py")?;
